...
class WindowsNativeRuntimeContractTests(unittest.IsolatedAsyncioTestCase):
    ...
    def test_child_environment_preserves_windows_runtime_core_paths(self) -> None:
        ...
        self.assertEqual(values["COMMONPROGRAMFILES"], r"C:\Program Files\Common Files")
        self.assertEqual(values["COMMONPROGRAMFILES(X86)"], r"C:\Program Files (x86)\Common Files")
        self.assertEqual(values["COMMONPROGRAMW6432"], r"C:\Program Files\Common Files")
        self.assertEqual(values["PROGRAMDATA"], r"C:\ProgramData")
        self.assertEqual(values["ALLUSERSPROFILE"], r"C:\ProgramData")
        self.assertEqual(values["PUBLIC"], r"C:\Users\Public")
        self.assertEqual(values["OS"], "Windows_NT")
        self.assertEqual(
            values["PSMODULEPATH"],
            r"C:\Program Files\WindowsPowerShell\Modules;"
            r"C:\Windows\System32\WindowsPowerShell\v1.0\Modules",
        )
        self.assertEqual(values["PSHOME"], r"C:\Windows\System32\WindowsPowerShell\v1.0")
