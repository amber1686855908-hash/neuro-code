"""Pure session-search projections and title/text helpers.

提供纯函数式会话搜索投影以及标题和文本辅助函数."""
...
from neuro_code.domain.sessions.models import MAX_SESSION_TITLE_CHARS, SessionSummary
...
def searchable_session_text(items: Sequence[SessionItem]) -> str:
    ...
    投影可见的会话和工具文本,不包含 Provider 私有上下文."""
