...
class OpenAIResponsesProvider:
    """Streaming Responses API adapter with optional xAI-specific behavior."""
...
class XAIResponsesProvider(OpenAIResponsesProvider):
    """Compatibility wrapper that selects the xAI Responses dialect."""
    ...
    def __init__(
        ...
        *,
        ...
        base_url: str,
        api_key: str,
        provider_name: str = "xai-responses",
        context_affinity: str | None = None,
        timeout_seconds: float = 120.0,
        max_output_tokens: int = 8192,
        builtin_tools: Sequence[str] = (),
